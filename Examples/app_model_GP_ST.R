...
names <- load("Examples/Data/NepalExtended_mean.RData")   # Loads 'dataset'
...
if (length(pred_objects) > 0) {
  save(list = pred_objects,
       file = "Examples/Data/Nepal_GP_pred_results.RData")
}
...
if (fit_d3) {
  ...
  save(
    ...
    S_warped_year,
    corr_ref1, corr_ref2,
    file = "Examples/Data/Nepal_GP_d3_plot_data.RData"
  )
}
